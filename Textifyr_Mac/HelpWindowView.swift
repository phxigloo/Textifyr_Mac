        ...
        content: HelpContent(
            ...
            uiViews: [
                ...
                HelpUIView(
                    ...
                    howItWorks: "Settings is divided into four tabs: General (AI and privacy options), Text Processing (filler words, cleanup rules, the glossary, and the default action), Stages (workflow stage management), and Windows (document window limits and quick links to the Action Editor and Prompt Builder).",
